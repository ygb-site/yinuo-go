...
| 00 | [phase1/00-product-positioning.md](./phase1/00-product-positioning.md) | 产品定位：家庭私有、双轨时间轴、围棋主线 |
...
| 10 | [phase1/10-parent-mode.md](./phase1/10-parent-mode.md) | 家长端：Together 优先、双轨设置、降级展示 |
...
6. **家庭私有。** 不开放注册；只用现有家庭账号登录。见 [supabase/README.md](../supabase/README.md)。
