...
export class GoGame {
     ...
     */
    isLegalMove(r, c, color = this.turn) {
        if (!this.isValidCoord(r, c)) {
    ...
    static runSelfTests() {
        ...
        test('中心独子应有 4 气，边上 3 气，角上 2 气', () => {
            ...
            return (g.getLibertiesCount(2, 2) === 4 &&
        ...
        test('打劫禁着点拦截：单子互提不能即时反提', () => {
            ...
            if (!res1.success || res1.capturedStones.length !== 1)
                return false;
