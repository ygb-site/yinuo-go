...
export const TSUMEGO_PUZZLES: TsumegoPuzzle[] = [
  // Capturing
  {
    ...
    hint: '点击白子右侧唯一的呼吸孔 (2, 3)！',
    explanation: '白子被三面包围，下在 (2, 3) 即可堵死其最后一口气并完成提子。',
  ...
  },
  {
    ...
    hint: '从右侧 (1, 3) 迎头兜截！',
    explanation: '在 (1, 3) 叫吃，白子无论怎么跑都会撞在黑棋的厚势上。',
  ...
  },
  {
    ...
    hint: '点在 (2, 1) 的正前方门位！',
    explanation: '门吃手筋，利用 (1,1) 与 (3,1) 的二子门户，于 (2,1) 形成致命卡位。',
  ...
  },
  {
    ...
    playerColor: 'B',
    prompt: '黑先，勇敢将黑子投入虎口 (2, 2)，发动倒扑！',
    hint: '点在 (2, 2) 诱饵点，白吃后立刻回提！',
  ...
  // Ko rule
  {
    ...
    playerColor: 'B',
    prompt: '黑先，白子在 (2, 3) 叫吃中，请在 (2, 2) 先手提劫！',
    hint: '下在 (2, 2) 提掉白子！',
