...
export const CHAPTERS_DATA: Chapter[] = [
  {
    ...
    "titleEn": "Chapter 1: The Board & Breath of Life",
    "icon": "✨",
    "themeColor": "from-emerald-400 to-teal-500",
    "description": "欢迎来到神奇围棋世界！认识交叉点、正中心天元、棋子的4条呼吸管道（气）、连手长气与自杀禁令！",
    "lessons": [
      {
        "id": "lesson_1_1",
        "chapterId": 1,
        ...
        "puzzleRoot": [
          {
            ...
            "comment": "太棒啦！棋子稳稳落在交叉点上！黑白小精灵开启大冒险！",
            "isCorrect": true
          }
        ],
        "subPuzzles": [
      ...
      },
      {
        ...
        "playerColor": "B",
        "goalText": "在黑子正上方（C2）落子体验气数！",
        "goalTextEn": "Play on C2 to feel the liberties around the stone!",
        "targetHighlight": [
          {
            "r": 1,
            "c": 2
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "中腹棋子呼吸最通畅，拥有4条气！",
                "isCorrect": true
              }
            ],
            "hint": "点击黑子正上方 C2 点。",
            "explanation": "棋盘中央的单颗棋子拥有4个相邻空位（4口气）。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：边路棋子的3条气管",
            "subtitle": "边上的棋子背靠墙壁只有3口气",
            "goalText": "在边路黑子右侧（C1）落子！",
            "storyDialogues": [
              "边路棋子有一面贴着墙壁，天生只有3口气！在它右边 C1 下子吧！"
            ],
            "boardSize": 5,
            "initialStones": [
              {
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "数得真准！边路棋子只有3口气！",
                "isCorrect": true
              }
            ],
            "hint": "点击顶部第一排右侧 C1 点。",
            "explanation": "边路棋子由于有一面是棋盘边界，因此只有3口气。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：角落棋子的2条气管",
            "subtitle": "角上的棋子仅有2口气",
            "goalText": "在角上黑子下方（A2）落子！",
            "storyDialogues": [
              "角上的棋子两面被墙壁卡住，天生只有2口气！在它下方 A2 下子！"
            ],
            "boardSize": 5,
            "initialStones": [
              {
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "火眼金睛！角上棋子仅有2气，最容易受攻击！",
                "isCorrect": true
              }
            ],
            "hint": "点击左上角黑子正下方 A2 点。",
            "explanation": "角部棋子受两面边界限制，天生仅有2气。"
          }
        ],
        "hint": "点击黑子正上方的交叉点 C2。",
      ...
      },
      {
        ...
        "type": "multi_step",
        "title": "1-3 连手长气与手拉手",
        "titleEn": "1-3 Connecting & Extending Liberties",
        "subtitle": "手拉手好朋友，合在一起气变多",
        "description": "两颗黑精灵紧紧挨着手拉手，它们的呼吸管道就会合并在一起，变成6条气，更强壮！",
        "storyDialogues": [
          "一个黑子势单力薄，但如果叫来好朋友手拉手呢？",
          "两颗紧紧相连的黑子合为一体，气数合并为6条！",
          "快来在黑子旁边下子，帮它们连手长气！"
        ],
        "boardSize": 5,
        "initialStones": [
        ...
        "subPuzzles": [
          ...
          },
          {
            ...
            "explanation": "边路棋子通过连接可以大幅增强抗风险能力。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：角部死地连手出逃",
            "subtitle": "向外逃生连手",
        ...
        "hint": "点击黑子正上方的交叉点 C2。",
        "explanation": "同色棋子通过直线相连后形成一个不可分割的整体，其气数为所有相连棋子外部空交叉点的总和。",
        "bilingualTerm": {
          "chinese": "连手与长气",
          "pinyin": "lián shǒu & zhǎng qì",
          "english": "Connection & Extending",
          "concept": "将同色棋子相连以增加整体气数与强度的基本行棋手法。"
        },
        "rewards": {
          "stars": 3,
          "coins": 30,
      ...
      },
      {
        ...
        "chapterId": 1,
        "type": "multi_step",
        "title": "1-4 危险禁区：禁着点与自杀禁令",
        "titleEn": "1-4 Forbidden Point (No Suicide)",
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "漂亮！左上角A1是禁着点，下在中心天元大获全胜！",
                "isCorrect": true
              }
            ],
            "hint": "点击正中心天元 C3。",
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "神之一手！虽然四周没气，但能提掉白子，所以这是合法的提子！第一章圆满毕业！",
                "isCorrect": true
              }
            ],
            "hint": "点击正中心 C3 提掉白子。",
  ...
  {
    "id": 2,
    "title": "第二章：吃子魔法与大救援（打吃与提子）",
    "titleEn": "Chapter 2: Atari, Capture & Escape",
    "icon": "⚡",
    "themeColor": "from-orange-400 to-amber-500",
    "description": "拉响危险红光警报（叫吃）、拔除最后一口气完成提子、自救逃跑与虎口陷阱！通关解锁【吃子对弈场】！",
    "lessons": [
      {
        "id": "lesson_2_1",
        "chapterId": 2,
        "type": "multi_step",
        "title": "2-1 危险警报拉响：叫吃（打吃）",
        "titleEn": "2-1 Danger Alarm: Atari!",
        ...
        "puzzleRoot": [
          {
            ...
            "comment": "滴嘟滴嘟！叫吃成功！白棋只剩右边最后1口气啦！",
            "isCorrect": true
          }
        ],
        "subPuzzles": [
      ...
      },
      {
        ...
        "chapterId": 2,
        "type": "multi_step",
        "title": "2-2 抓捕白怪大作战：提子",
        "titleEn": "2-2 Capture the Spirit: Capture!",
      ...
      },
      {
        ...
        "chapterId": 2,
        "type": "multi_step",
        "title": "2-3 危险自救：逃跑与长气",
        "titleEn": "2-3 Escape and Extend Liberties",
        ...
        "puzzleRoot": [
          {
            ...
            "comment": "太棒啦！黑子成功逃出生天，手拉手长出了3条新气！",
            "isCorrect": true
          }
        ],
        "subPuzzles": [
      ...
      },
      {
        ...
        "chapterId": 2,
        "type": "multi_step",
        "title": "2-4 虎口陷阱与提吃虎口之子",
        "titleEn": "2-4 Tiger's Mouth Trap & Capture",
        "subtitle": "识破虎口危险，提吃自投罗网之敌",
        "description": "三颗黑子围成品字形虎口，白棋跳进去就是送死！果断落子提吃它！",
        "storyDialogues": [
          "大老虎张开嘴巴，这就是【虎口】！",
          "白棋如果敢跳进黑棋的虎口里，自身立刻变成最后1口气！",
          "黑棋只要在虎口正中心落子，就能一口把白子吃掉！快来试一试！"
        ],
        "boardSize": 5,
        "initialStones": [
          {
        ...
        "playerColor": "B",
        "goalText": "在虎口中心（D3）落子，一口吃掉跳入虎口的白子！",
        "goalTextEn": "Capture the trapped stone directly inside the tiger mouth!",
        "targetHighlight": [
          {
            "r": 2,
            "c": 3
        ...
        "puzzleRoot": [
          {
            ...
            "comment": "嗷呜！虎口合拢，一口吃掉白子！第二章圆满毕业！",
            "isCorrect": true
          }
        ],
        "subPuzzles": [
          {
            ...
            "hint": "点击 D3 封住虎口。",
            "explanation": "跳入虎口的敌子处于叫吃状态，可直接提吃。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：边路虎口防守",
            "subtitle": "借助边线构筑虎口",
            "goalText": "在边路（C1）落子吃掉白子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "hint": "点击 C1 点提吃。",
            "explanation": "边路虎口借助边缘具有极强防御力。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：构筑自己的安全虎口",
            "subtitle": "三子成虎口",
            "goalText": "在上方（C2）落子筑成虎口！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 2,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "虎口筑成！敌人再也不敢轻易靠近！",
                "isCorrect": true
              }
            ],
            "hint": "点击 C2 点形成虎口。",
            "explanation": "构筑虎口是实战防守与反击的高效形状。"
          }
        ],
        "hint": "在右侧 D3 堵死最后一口气完成提吃。",
        "explanation": "“虎口”是由三颗同色棋子构成的凹形要害，敌人若无准备贸然进入即成被叫吃状态。",
        "bilingualTerm": {
          "chinese": "虎口",
          "pinyin": "hǔ kǒu",
          "english": "Tiger's Mouth (Kake)",
          "concept": "三颗同色棋子呈品字形排列的形状，具有极强的防御和捕杀能力。"
        },
        "rewards": {
          "stars": 3,
          "coins": 40,
  ...
  },
  {
    ...
    "titleEn": "Chapter 3: Tactical Capture Arsenal (Tesuji)",
    "icon": "🎣",
    ...
    "lessons": [
      {
        ...
        "type": "multi_step",
        "title": "3-1 双叫吃：一石二鸟",
        "titleEn": "3-1 Double Atari (Two Birds One Stone)",
      ...
      },
      {
        ...
        "type": "multi_step",
        "title": "3-2 抱吃（往怀里赶）",
        "titleEn": "3-2 Hug Capture (Embrace)",
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "关门插闩！整块白子全部提清！",
                "isCorrect": true
              }
            ],
            "hint": "点击底部 C5 点。",
            "explanation": "门吃在狭窄处威力巨大。"
          }
        ],
        "hint": "请在上方门口 C2 落子提吃。",
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "精准叫吃！白子只能向下逃！",
                "isCorrect": true
              }
            ],
            "hint": "点击右侧 D3 点叫吃。",
            "explanation": "征吃第一步要截断直行，逼其转向。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：阶梯追击第二步",
            "subtitle": "之字形连续施压",
            "goalText": "在左侧（B4）继续叫吃！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 3,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "扭羊头成型！白子无处遁形！",
                "isCorrect": true
              }
            ],
            "hint": "点击左侧 B4 点。",
            "explanation": "左右交替叫吃形成连续阶梯。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：悬崖提子终局",
            "subtitle": "一路撞墙提吃",
            "goalText": "在下方（C5）封死最后一口气！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 4,
        ...
        "subPuzzles": [
          {
            ...
            "hint": "在白子斜上方 D2 点落子。",
            "explanation": "枷吃不贴身叫吃，而是隔一路虚扣封锁。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：边路小飞枷",
            "subtitle": "借边路屏障合围",
            "goalText": "在前方（C1）落子小飞枷！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "hint": "点击顶部 C1 点。",
            "explanation": "边路飞枷效率极高。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：提吃入网之鱼",
            "subtitle": "收网提子",
            "goalText": "在上方（C2）落子完成提吃！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 2,
      ...
      },
      {
        ...
        "chapterId": 3,
        "type": "multi_step",
        "title": "3-6 倒扑（诱敌深入的魔术）",
        "titleEn": "3-6 The Snapback (Uttegaeshi)",
        ...
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：投下诱饵触发倒扑",
            "subtitle": "送子入虎口自紧气",
            "goalText": "在白棋虎口（D2）投子倒扑！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "诱饵送入！白棋立刻只剩1口气！",
                "isCorrect": true
              }
            ],
            "hint": "在白棋右侧虎口 D2 点黑子。",
            "explanation": "倒扑通过弃子使敌方气数骤降。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：角部倒扑绝杀",
            "subtitle": "角上虎口反提",
            "goalText": "在左上角虎口（B1）投子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "角部倒扑成功！两颗白子立毙！",
                "isCorrect": true
              }
            ],
            "hint": "点击顶部 A2 点。",
            "explanation": "角部倒扑杀伤力极高。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：反提大龙收官",
            "subtitle": "完成最终反提",
            "goalText": "在原位（D2）反提整串白子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "大反提！第二章吃子手筋全部大通关！",
                "isCorrect": true
              }
            ],
            "hint": "点击 D2 点反提。",
            "explanation": "倒扑反提是围棋最具戏剧性的手筋。"
          }
        ],
  ...
  {
    "id": 4,
    "title": "第四章：死活城堡与无敌安全屋（眼位与生存）",
    "titleEn": "Chapter 4: The Living Castle (Eyes & Life)",
    "icon": "🏰",
    ...
    "lessons": [
      {
        ...
        "titleEn": "4-1 Eye Space: The Safe Haven",
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "中腹眼位建好！白棋不敢下入！",
                "isCorrect": true
              }
            ],
            "hint": "点击右侧 D3 点。",
            "explanation": "四面合围的空交叉点即构成眼位。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：角部天生眼位",
            "subtitle": "借角部双壁做眼",
            "goalText": "在左上角关键点（B2）落子做眼！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "hint": "点击左上角 B2 点。",
            "explanation": "角部只需2~3颗子即可快速成眼。"
          },
          {
            "stepIndex": 3,
            "title": "第 3 题：边路眼位加固",
            "subtitle": "封闭边线大门",
            "goalText": "在边路（C2）落子筑造眼位！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
      ...
      },
      {
        ...
        "type": "multi_step",
        "title": "4-2 辨别真眼与假眼",
        "titleEn": "4-2 Real Eye vs False Eye",
        ...
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：补强斜角化假为真",
            "subtitle": "守护对角破损点",
            "goalText": "在右上对角（D2）下黑子补强！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "hint": "点击右上角斜点 D2。",
            "explanation": "真眼四个对角至少要有3个己方子保护。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：戳穿白棋假眼",
            "subtitle": "识破白棋斜角漏洞",
            "goalText": "在白棋斜角要害（C2）落子破坏！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "一击命中！白棋假眼被破，大龙难逃！",
                "isCorrect": true
              }
            ],
            "hint": "点击右上斜角 C2 点。",
            "explanation": "攻击对方假眼斜角，可使对方眼位失效。"
          }
        ],
      ...
      },
      {
        ...
        "type": "multi_step",
        "title": "4-3 两眼活棋：不死神功",
        "titleEn": "4-3 Two Eyes for Immortality (Life)",
        ...
        "playerColor": "B",
        "goalText": "在中间（C3 / r:2, c:2）落子，一分为二，做出两只独立的真眼！",
        "goalTextEn": "Play on C3 to divide the space into two independent living eyes!",
        "targetHighlight": [
          {
            "r": 2,
            "c": 2
        ...
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：中腹一分为二做双眼",
            "subtitle": "做出两只独立真眼",
            "goalText": "在正中心（C3）下黑子分眼！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "hint": "点击正中心 C3 点。",
            "explanation": "两只独立真眼确保对方无法同时叫吃，属于活棋。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：角部双眼做活",
            "subtitle": "角上分割两个小真眼",
            "goalText": "在角上要害（B2）落子分两眼！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "hint": "点击 B2 点。",
            "explanation": "角部通过下在中间要害点分出两只眼。"
          }
        ],
        "hint": "在正中央下黑子 C3，把大眼隔成左右两个独立小真眼。",
      ...
      },
      {
        ...
        "chapterId": 4,
        "type": "multi_step",
        "title": "4-4 死活要害：直三与弯三急所",
        "titleEn": "4-4 Vital Point: Straight & Bent Three",
        "subtitle": "直三中间点要害，敌之要点即我之要点",
        ...
        "bilingualTerm": {
          "chinese": "直三与急所",
          "pinyin": "zhí sān & jí suǒ",
          "english": "Straight Three & Vital Point",
      ...
      },
      {
        ...
        "chapterId": 4,
        "type": "multi_step",
        "title": "4-5 乒乓球规则：打劫与劫争",
        "titleEn": "4-5 The Ko Rule (No Infinite Loop)",
        ...
        "subPuzzles": [
          ...
          {
            "stepIndex": 2,
            "title": "第 2 题：消劫粘劫锁定胜利",
            "subtitle": "白棋应劫后把劫粘上",
            "goalText": "在劫位（C3）粘劫完成胜利！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 2,
  ...
  {
    "id": 5,
    "title": "第五章：圈地大作战与空间魔法（大局与行棋）",
    "titleEn": "Chapter 5: Territory Magic & Strategic Space",
    "icon": "🗺️",
    "themeColor": "from-blue-400 to-indigo-500",
    "description": "分断连接、金角银边草肚皮、天元星位、基本行棋手法与紧气对杀！围棋不仅是吃子，更是圈地盘！通关解锁【萌宠AI对弈】！",
    "lessons": [
      {
        "id": "lesson_5_1",
        "chapterId": 5,
        ...
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：一刀两断切分白棋",
            "subtitle": "切断弱联络",
            "goalText": "在交叉要害（B3）落子切断！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "分断成功！敌方陷入各自为战！",
                "isCorrect": true
              }
            ],
            "hint": "点击 B3 点分断。",
            "explanation": "分断是发起进攻的核心第一步。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：防守连接固若金汤",
            "subtitle": "连接己方弱点",
            "goalText": "在连接点（C2）下黑子连通！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
      ...
      },
      {
        ...
        "chapterId": 5,
        "type": "multi_step",
        "title": "5-2 空间第一法则：金角、银边、草肚皮",
        "titleEn": "5-2 Gold Corner, Silver Side, Grass Belly",
        ...
        "subPuzzles": [
          {
            ...
            "hint": "点击左上角 B2 点。",
            "explanation": "角部占地最省子力。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：抢占右下金角",
            "subtitle": "四角皆为金库",
            "goalText": "在右下角星位（D4）落子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
      ...
      },
      {
        ...
        "chapterId": 5,
        "type": "multi_step",
        "title": "5-3 棋盘黄金地标：星位、三三与小目",
        "titleEn": "5-3 Star Points, 3-3 & Komoku",
        "subtitle": "角星位辐射势力，三三守住角部黄金金库",
        "description": "棋盘上的黑色小星点就是【星位】（Hoshi），角上的三·三是天然金库，小目攻守兼备！",
        "storyDialogues": [
        ...
        "subPuzzles": [
          {
            ...
            "hint": "点击右上星位 D2 点。",
            "explanation": "星位兼顾取势与实地。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：三·三点占角部金库",
            "subtitle": "牢固占领角部实地",
            "goalText": "在左下角三·三点（B4）落子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "三三占库！角部实地稳稳入账！",
                "isCorrect": true
              }
            ],
            "hint": "点击左下角 B4 点。",
            "explanation": "三三点直接锁定角部所有实地。"
          }
        ],
        "hint": "点击右上角星位 D2。",
        ...
        "bilingualTerm": {
          "chinese": "星位与三三",
          "pinyin": "xīng wèi & sān sān",
          "english": "Star Point & 3-3 Point",
      ...
      },
      {
        ...
        "chapterId": 5,
        "type": "multi_step",
        "title": "5-4 基本行棋手法：长、立、扳、尖、跳",
        "titleEn": "5-4 Core Move Types: Nobi, Hane, Tobi",
        "subtitle": "掌握长厚实、扳阻截、尖牢固与跳出头",
        "description": "围棋的基本步伐！长得厚实、扳住对方头顶、尖得牢固、跳得飞快！",
        "storyDialogues": [
          "围棋小武士有自己的招数步伐！",
          "在对方头顶斜角处施展【扳】（Hane），可以强力阻截对方前进！",
          "快来施展你的漂亮一扳吧！"
        ],
        "boardSize": 5,
        "initialStones": [
        ...
        "playerColor": "B",
        "goalText": "在白子头顶斜角处（B2 / r:1, c:1）施展强力一【扳】！",
        "goalTextEn": "Play on B2 to deliver a powerful Hane!",
        "targetHighlight": [
          {
            "r": 1,
            "c": 1
        ...
        "subPuzzles": [
          {
            ...
            "hint": "点击 B2 点。",
            "explanation": "扳能有效阻截对方行棋方向。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：一间跳快速出头",
            "subtitle": "隔一格向前飞跃",
            "goalText": "在上方（C2）跳一步出头！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 3,
            ...
            "hint": "点击 C2 点。",
            "explanation": "跳能迅速抢占前方空间。"
          }
        ],
        "hint": "在白子上方斜角 B2 扳住白子。",
        "explanation": "扳（Hane）、跳（Tobi）、尖（Kosumi）是围棋中最核心的基础运子手法。",
        "bilingualTerm": {
          "chinese": "扳与跳",
          "pinyin": "bān & tiào",
          "english": "Hane & Tobi",
          "concept": "围棋最基础也是最核心的运子手法，兼具进攻与速度。"
        },
        "rewards": {
          "stars": 3,
          "coins": 40,
      ...
      },
      {
        ...
        "chapterId": 5,
        "type": "multi_step",
        "title": "5-5 紧气对杀：谁的气多谁胜利",
        "titleEn": "5-5 Capturing Race (Semeai)",
        ...
        "puzzleRoot": [
          {
            ...
            "comment": "精准紧气！白棋只剩最后1气，黑棋对杀大获全胜！第五章圆满毕业！",
            "isCorrect": true
          }
        ],
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：先紧外气赢得对杀",
            "subtitle": "比拼谁的速度更快",
            "goalText": "在外侧（D3）紧白棋外气！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 2,
            ...
            "hint": "点击 D3 紧外气。",
            "explanation": "对杀基本口诀：先紧外气，后紧公气。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：有公气时的对杀次序",
            "subtitle": "保留公气先紧外气",
            "goalText": "在上方外侧（C1）紧外气！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "漂亮！紧外气压制对方速度！第五章大圆满！",
                "isCorrect": true
              }
            ],
            "hint": "点击顶部 D1 点。",
            "explanation": "公气双方共有，先紧外气才能确保速度优势。"
          }
        ],
  ...
  {
    "id": 6,
    "title": "第六章：筑城终局与小棋圣毕业考（胜负与定段）",
    "titleEn": "Chapter 6: Fortress, Endgame & Graduation Exam",
    "icon": "🏆",
    "themeColor": "from-purple-500 to-pink-500",
    "description": "封锁边界、官子收官、终局数子点目、棋道礼仪与九路巅峰考！通关解锁【定段升级考（荣誉证书）】与【自由打谱台】！",
    "lessons": [
      {
        "id": "lesson_6_1",
        "chapterId": 6,
        "type": "multi_step",
        "title": "6-1 封锁边界与筑城领地",
        "titleEn": "6-1 Enclosing Territories & Fortress",
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "大门关紧！左边全部成为黑地！",
                "isCorrect": true
              }
            ],
            "hint": "点击 C4 点。",
            "explanation": "封锁边界划定领地归属。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：边线加固筑城",
            "subtitle": "补齐最后一块城砖",
            "goalText": "在边线（C5）落子锁死边界！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "城堡固若金汤！领地完全确立！",
                "isCorrect": true
              }
            ],
            "hint": "点击最底部 C5 点。",
            "explanation": "完整闭合的边界才算真正的目数领地。"
          }
        ],
      ...
      },
      {
        ...
        "type": "multi_step",
        "title": "6-2 官子收官抢占金币",
        "titleEn": "6-2 Endgame (Yose) Micro-Points",
        ...
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：一路先手官子推进",
            "subtitle": "抢占边界前沿",
            "goalText": "在顶部边界（B1）落子收官！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "hint": "点击顶部 B1 点。",
            "explanation": "先手官子不损手数，能多抢目数。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：二路大官子搜刮",
            "subtitle": "抢占角部二路金币",
            "goalText": "在底部二路（D4）落子收官！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 3,
            ...
            "hint": "点击 C4 点。",
            "explanation": "二路官子价值极大，常有一子定乾坤之效。"
          }
        ],
      ...
      },
      {
        ...
        "titleEn": "6-3 Counting Territory & Final Victory",
        ...
        "subPuzzles": [
          {
            ...
            "hint": "点击正中心 C3 点。",
            "explanation": "双方无棋可下时宣告终局。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：清理死子与点目胜负",
            "subtitle": "清点最终地盘目数",
            "goalText": "在清点确认点（C3）落子确认胜负！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 0,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "点目胜出！黑方领地大于白方，胜利！",
                "isCorrect": true
              }
            ],
            "hint": "点击 C3 点确认。",
            "explanation": "围棋最终以围地多者胜。"
          }
        ],
        "hint": "点击正中心终局点 C3。",
      ...
      },
      {
        ...
        "type": "multi_step",
        "title": "6-4 棋道精神与对局礼仪",
        "titleEn": "6-4 Go Etiquette & Sportsmanship",
        "subtitle": "知书达礼、落子无悔、胜不骄败不馁",
        "description": "围棋是君子之艺，对局前行礼致敬，下棋时落子无悔，对局后互相致谢复盘！",
        "storyDialogues": [
          "下围棋不仅比拼智慧，更讲究礼貌和风度！",
          "对局开始前，小棋手要端坐行礼：“请多指教”！",
          "落下棋子就要对自己的决定负责，决不悔棋！快在天元落子开启礼仪之弈！"
        ],
        "boardSize": 5,
        "initialStones": [],
        "playerColor": "B",
        "goalText": "在天元（C3）端正落下君子第一子！",
        "goalTextEn": "Place your stone with respect on Tengen C3!",
        "targetHighlight": [
          {
            "r": 2,
            "c": 2
        ...
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：端正坐姿，落子无悔",
            "subtitle": "对局前致敬行礼",
            "goalText": "在天元（C3）端正落子！",
            "boardSize": 5,
            "initialStones": [],
            "playerColor": "B",
            "targetHighlight": [
            ...
            "hint": "点击正中 C3 点。",
            "explanation": "下棋时专心致志、落子无悔。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：终局致谢与复盘",
            "subtitle": "对局后互相学习交流",
            "goalText": "在右上星位（D2）落子致谢！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 2,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "胜不骄败不馁！你已具备真正棋手的胸怀！",
                "isCorrect": true
              }
            ],
            "hint": "点击 D2 点。",
            "explanation": "复盘交流是棋力飞速提升的秘诀。"
          }
        ],
        "hint": "点击正中天元 C3 点。",
        "explanation": "围棋讲究“以棋修身”，尊重对手、落子无悔、谦虚求学是小棋圣的核心修养。",
        "bilingualTerm": {
          "chinese": "棋道礼仪",
          "pinyin": "qí dào lǐ yí",
          "english": "Go Etiquette & Spirit",
          "concept": "对局前致礼、行棋不悔、对局后复盘的围棋高尚修养。"
        },
        "rewards": {
          "stars": 3,
          "coins": 40,
      ...
      },
      {
        ...
        "chapterId": 6,
        "type": "multi_step",
        "title": "6-5 毕业试炼：决战九路巅峰考",
        "titleEn": "6-5 Master Trial: 9x9 Graduation Challenge",
        ...
        "puzzleRoot": [
          {
            ...
            "comment": "太精彩啦！神来之笔！恭喜你通过全部 6 大篇章试炼，成为真正的围棋小棋圣！",
            "isCorrect": true
          }
        ],
        "subPuzzles": [
          {
            "stepIndex": 1,
            "title": "第 1 题：中盘胜负手双叫吃",
            "subtitle": "决胜中原",
            "goalText": "在中央核心要害（C3）下黑子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "一击制胜！双叫吃奠定胜势！",
                "isCorrect": true
              }
            ],
            "hint": "点击正中心 C3 点。",
            "explanation": "综合运用双叫吃锁定胜局。"
          },
          {
            "stepIndex": 2,
            "title": "第 2 题：毕业定音一击",
            "subtitle": "小棋圣最高荣誉",
            "goalText": "在决胜要害（D2）落下毕业之子！",
            "boardSize": 5,
            "initialStones": [
              {
                "r": 1,
            ...
            "puzzleRoot": [
              {
                ...
                "comment": "🎉 恭喜毕业！你已经成为合格的围棋小高手！正式解锁定段考与荣誉证书！",
                "isCorrect": true
              }
            ],
            "hint": "点击 D2 点提吃。",
            "explanation": "恭喜你通关全部启蒙课程！"
          }
        ],
        "hint": "点击正中心唯一的胜负手 C3。",
