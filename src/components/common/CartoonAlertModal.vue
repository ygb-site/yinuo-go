...
<template>
  <Teleport to="body">
    <div
      ...
      class="fixed inset-0 z-[10000] overflow-hidden bg-black/60 no-scrollbar modal-overlay backdrop-blur-md select-none animate-fade-in flex items-center justify-center p-4"
