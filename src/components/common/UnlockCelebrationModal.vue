...
<template>
  <Teleport to="body">
    <div
      v-if="isOpen && feature"
      class="fixed inset-0 z-[10000] overflow-y-auto bg-black/70 backdrop-blur-md select-none animate-fade-in flex items-center justify-center p-3 sm:p-4"
      @click.self="handleClose"
    >
      <div
        class="relative w-full max-w-md max-h-[96vh] overflow-y-auto transform rounded-3xl bg-white p-6 sm:p-7 text-center shadow-2xl border-4 border-amber-300 transition-all animate-pop-in z-[10001] my-auto"
      >
        <!-- Close Button -->
        <button
          type="button"
